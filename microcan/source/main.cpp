...
int main(void)
{
  ...
  // Depends on Ressource::storage.start(). ADC1 remains dedicated to the
  // continuous board voltage and temperature survey in every role setup.
  Adc::start();
  
  if (param_cget<"ROLE.identification">()) {
    // mode identification
