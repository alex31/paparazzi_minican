...
`ImavRole` acquires PA4, ADC2 and TIM6 for its single 23.9977 kHz microphone
channel on ADC2_IN17. ADC1 remains dedicated to continuous voltage and core
temperature monitoring. The role also starts the shared I2C1 infrastructure
for the OPT4060 and, when `role.imav.time_of_flight` is enabled, the optional
VL53L4CX on PA15/PB07.
