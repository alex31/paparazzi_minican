 ...
 */
      ...
      // Weight of the newest burst or continuous 200 ms window in the SNR IIR.
      // 1 disables smoothing; the value is read live for every SNR publication.
      ...
      {"role.imav.light.cree_test", {.v = false}},
