 ...
 * Board identifier.
 */
#define BOARD_ENAC_MINICANv4
#define BOARD_NAME                  "Enac MiniCanV4" // early prototype, boot0 - i2c conflict
...
#define	PA01_PULLUP_SDA                1U
#define	PA02_DBG_TX                    2U
#define	PA03_DBG_RX                    3U
#define	PA04_SPI_PERIPH_CS             4U
#define	PA05_SPI_SCK                   5U
#define	PA06_SPI_MISO                  6U
#define	PA07_SPI_MOSI                  7U
#define	PA08_SRV1                      8U
#define	PA09_SRV2                      9U
#define	PA10_SRV3                      10U
#define	PA11_SRV4                      11U
#define	PA12_PULLUP_SCL                12U
#define	PA13_SWDIO                     13U
#define	PA14_SWCLK                     14U
#define	PA15_I2C_SCL                   15U

#define	PB00_SPI_EEPROM_CS             0U
#define	PB01                           1U
#define	PB02                           2U
#define	PB03_UART_TX                   3U
#define	PB04_UART_RX                   4U
#define	PB05_FDCAN_RX                  5U
#define	PB06_FDCAN_TX                  6U
#define	PB07_I2C_SDA                   7U
...
#define	LINE_PULLUP_SDA                PAL_LINE(GPIOA, 1U)
#define	LINE_DBG_TX                    PAL_LINE(GPIOA, 2U)
#define	LINE_DBG_RX                    PAL_LINE(GPIOA, 3U)
#define	LINE_SPI_PERIPH_CS             PAL_LINE(GPIOA, 4U)
#define	LINE_SPI_SCK                   PAL_LINE(GPIOA, 5U)
#define	LINE_SPI_MISO                  PAL_LINE(GPIOA, 6U)
#define	LINE_SPI_MOSI                  PAL_LINE(GPIOA, 7U)
#define	LINE_SRV1                      PAL_LINE(GPIOA, 8U)
#define	LINE_SRV2                      PAL_LINE(GPIOA, 9U)
#define	LINE_SRV3                      PAL_LINE(GPIOA, 10U)
#define	LINE_SRV4                      PAL_LINE(GPIOA, 11U)
#define	LINE_PULLUP_SCL                PAL_LINE(GPIOA, 12U)
#define	LINE_SWDIO                     PAL_LINE(GPIOA, 13U)
#define	LINE_SWCLK                     PAL_LINE(GPIOA, 14U)
#define	LINE_I2C_SCL                   PAL_LINE(GPIOA, 15U)

#define	LINE_SPI_EEPROM_CS             PAL_LINE(GPIOB, 0U)
#define	LINE_UART_TX                   PAL_LINE(GPIOB, 3U)
#define	LINE_UART_RX                   PAL_LINE(GPIOB, 4U)
...
#define	LINE_CAN_TERMR_EN              PAL_LINE(GPIOF, 1U)
...
#define VAL_GPIOA_MODER                 (PIN_MODE_ANALOG(PA00_PS_5V) | \
					 PIN_MODE_OUTPUT(PA01_PULLUP_SDA) | \
					 PIN_MODE_ALTERNATE(PA02_DBG_TX) | \
					 PIN_MODE_ALTERNATE(PA03_DBG_RX) | \
					 PIN_MODE_OUTPUT(PA04_SPI_PERIPH_CS) | \
					 PIN_MODE_ALTERNATE(PA05_SPI_SCK) | \
					 PIN_MODE_ALTERNATE(PA06_SPI_MISO) | \
					 PIN_MODE_ALTERNATE(PA07_SPI_MOSI) | \
					 PIN_MODE_ALTERNATE(PA08_SRV1) | \
					 PIN_MODE_ALTERNATE(PA09_SRV2) | \
					 PIN_MODE_ALTERNATE(PA10_SRV3) | \
					 PIN_MODE_ALTERNATE(PA11_SRV4) | \
					 PIN_MODE_OUTPUT(PA12_PULLUP_SCL) | \
					 PIN_MODE_ALTERNATE(PA13_SWDIO) | \
					 PIN_MODE_ALTERNATE(PA14_SWCLK) | \
					 PIN_MODE_ALTERNATE(PA15_I2C_SCL))

#define VAL_GPIOA_OTYPER                (PIN_OTYPE_PUSHPULL(PA00_PS_5V) | \
					 PIN_OTYPE_PUSHPULL(PA01_PULLUP_SDA) | \
					 PIN_OTYPE_PUSHPULL(PA02_DBG_TX) | \
					 PIN_OTYPE_PUSHPULL(PA03_DBG_RX) | \
					 PIN_OTYPE_PUSHPULL(PA04_SPI_PERIPH_CS) | \
					 PIN_OTYPE_PUSHPULL(PA05_SPI_SCK) | \
					 PIN_OTYPE_PUSHPULL(PA06_SPI_MISO) | \
					 PIN_OTYPE_PUSHPULL(PA07_SPI_MOSI) | \
					 PIN_OTYPE_PUSHPULL(PA08_SRV1) | \
					 PIN_OTYPE_PUSHPULL(PA09_SRV2) | \
					 PIN_OTYPE_PUSHPULL(PA10_SRV3) | \
					 PIN_OTYPE_PUSHPULL(PA11_SRV4) | \
					 PIN_OTYPE_PUSHPULL(PA12_PULLUP_SCL) | \
					 PIN_OTYPE_PUSHPULL(PA13_SWDIO) | \
					 PIN_OTYPE_PUSHPULL(PA14_SWCLK) | \
					 PIN_OTYPE_OPENDRAIN(PA15_I2C_SCL))

#define VAL_GPIOA_OSPEEDR               (PIN_OSPEED_SPEED_VERYLOW(PA00_PS_5V) | \
					 PIN_OSPEED_SPEED_VERYLOW(PA01_PULLUP_SDA) | \
					 PIN_OSPEED_SPEED_HIGH(PA02_DBG_TX) | \
					 PIN_OSPEED_SPEED_HIGH(PA03_DBG_RX) | \
					 PIN_OSPEED_SPEED_MEDIUM(PA04_SPI_PERIPH_CS) | \
					 PIN_OSPEED_SPEED_HIGH(PA05_SPI_SCK) | \
					 PIN_OSPEED_SPEED_HIGH(PA06_SPI_MISO) | \
					 PIN_OSPEED_SPEED_HIGH(PA07_SPI_MOSI) | \
					 PIN_OSPEED_SPEED_HIGH(PA08_SRV1) | \
					 PIN_OSPEED_SPEED_HIGH(PA09_SRV2) | \
					 PIN_OSPEED_SPEED_HIGH(PA10_SRV3) | \
					 PIN_OSPEED_SPEED_HIGH(PA11_SRV4) | \
					 PIN_OSPEED_SPEED_VERYLOW(PA12_PULLUP_SCL) | \
					 PIN_OSPEED_SPEED_HIGH(PA13_SWDIO) | \
					 PIN_OSPEED_SPEED_HIGH(PA14_SWCLK) | \
					 PIN_OSPEED_SPEED_HIGH(PA15_I2C_SCL))

#define VAL_GPIOA_PUPDR                 (PIN_PUPDR_FLOATING(PA00_PS_5V) | \
					 PIN_PUPDR_FLOATING(PA01_PULLUP_SDA) | \
					 PIN_PUPDR_FLOATING(PA02_DBG_TX) | \
					 PIN_PUPDR_FLOATING(PA03_DBG_RX) | \
					 PIN_PUPDR_FLOATING(PA04_SPI_PERIPH_CS) | \
					 PIN_PUPDR_FLOATING(PA05_SPI_SCK) | \
					 PIN_PUPDR_FLOATING(PA06_SPI_MISO) | \
					 PIN_PUPDR_FLOATING(PA07_SPI_MOSI) | \
					 PIN_PUPDR_FLOATING(PA08_SRV1) | \
					 PIN_PUPDR_FLOATING(PA09_SRV2) | \
					 PIN_PUPDR_FLOATING(PA10_SRV3) | \
					 PIN_PUPDR_FLOATING(PA11_SRV4) | \
					 PIN_PUPDR_FLOATING(PA12_PULLUP_SCL) | \
					 PIN_PUPDR_FLOATING(PA13_SWDIO) | \
					 PIN_PUPDR_FLOATING(PA14_SWCLK) | \
					 PIN_PUPDR_PULLUP(PA15_I2C_SCL))

#define VAL_GPIOA_ODR                   (PIN_ODR_LEVEL_LOW(PA00_PS_5V) | \
					 PIN_ODR_LEVEL_LOW(PA01_PULLUP_SDA) | \
					 PIN_ODR_LEVEL_HIGH(PA02_DBG_TX) | \
					 PIN_ODR_LEVEL_HIGH(PA03_DBG_RX) | \
					 PIN_ODR_LEVEL_HIGH(PA04_SPI_PERIPH_CS) | \
					 PIN_ODR_LEVEL_HIGH(PA05_SPI_SCK) | \
					 PIN_ODR_LEVEL_HIGH(PA06_SPI_MISO) | \
					 PIN_ODR_LEVEL_HIGH(PA07_SPI_MOSI) | \
					 PIN_ODR_LEVEL_LOW(PA08_SRV1) | \
					 PIN_ODR_LEVEL_LOW(PA09_SRV2) | \
					 PIN_ODR_LEVEL_LOW(PA10_SRV3) | \
					 PIN_ODR_LEVEL_LOW(PA11_SRV4) | \
					 PIN_ODR_LEVEL_LOW(PA12_PULLUP_SCL) | \
					 PIN_ODR_LEVEL_HIGH(PA13_SWDIO) | \
					 PIN_ODR_LEVEL_HIGH(PA14_SWCLK) | \
					 PIN_ODR_LEVEL_HIGH(PA15_I2C_SCL))

#define VAL_GPIOA_AFRL			(PIN_AFIO_AF(PA00_PS_5V, 0) | \
					 PIN_AFIO_AF(PA01_PULLUP_SDA, 0) | \
					 PIN_AFIO_AF(PA02_DBG_TX, 12) | \
					 PIN_AFIO_AF(PA03_DBG_RX, 12) | \
					 PIN_AFIO_AF(PA04_SPI_PERIPH_CS, 0) | \
					 PIN_AFIO_AF(PA05_SPI_SCK, 5) | \
					 PIN_AFIO_AF(PA06_SPI_MISO, 5) | \
					 PIN_AFIO_AF(PA07_SPI_MOSI, 5))

#define VAL_GPIOA_AFRH			(PIN_AFIO_AF(PA08_SRV1, 6) | \
					 PIN_AFIO_AF(PA09_SRV2, 6) | \
					 PIN_AFIO_AF(PA10_SRV3, 6) | \
					 PIN_AFIO_AF(PA11_SRV4, 11) | \
					 PIN_AFIO_AF(PA12_PULLUP_SCL, 0) | \
					 PIN_AFIO_AF(PA13_SWDIO, 0) | \
					 PIN_AFIO_AF(PA14_SWCLK, 0) | \
					 PIN_AFIO_AF(PA15_I2C_SCL, 4))

#define VAL_GPIOB_MODER                 (PIN_MODE_OUTPUT(PB00_SPI_EEPROM_CS) | \
					 PIN_MODE_INPUT(PB01) | \
					 PIN_MODE_INPUT(PB02) | \
					 PIN_MODE_ALTERNATE(PB03_UART_TX) | \
					 PIN_MODE_ALTERNATE(PB04_UART_RX) | \
					 PIN_MODE_ALTERNATE(PB05_FDCAN_RX) | \
					 PIN_MODE_ALTERNATE(PB06_FDCAN_TX) | \
					 PIN_MODE_ALTERNATE(PB07_I2C_SDA) | \
...
#define VAL_GPIOB_OTYPER                (PIN_OTYPE_PUSHPULL(PB00_SPI_EEPROM_CS) | \
					 PIN_OTYPE_OPENDRAIN(PB01) | \
					 PIN_OTYPE_OPENDRAIN(PB02) | \
					 PIN_OTYPE_PUSHPULL(PB03_UART_TX) | \
					 PIN_OTYPE_PUSHPULL(PB04_UART_RX) | \
					 PIN_OTYPE_PUSHPULL(PB05_FDCAN_RX) | \
					 PIN_OTYPE_PUSHPULL(PB06_FDCAN_TX) | \
					 PIN_OTYPE_OPENDRAIN(PB07_I2C_SDA) | \
...
#define VAL_GPIOB_OSPEEDR               (PIN_OSPEED_SPEED_HIGH(PB00_SPI_EEPROM_CS) | \
					 PIN_OSPEED_SPEED_VERYLOW(PB01) | \
					 PIN_OSPEED_SPEED_VERYLOW(PB02) | \
					 PIN_OSPEED_SPEED_HIGH(PB03_UART_TX) | \
					 PIN_OSPEED_SPEED_HIGH(PB04_UART_RX) | \
					 PIN_OSPEED_SPEED_HIGH(PB05_FDCAN_RX) | \
					 PIN_OSPEED_SPEED_HIGH(PB06_FDCAN_TX) | \
					 PIN_OSPEED_SPEED_HIGH(PB07_I2C_SDA) | \
...
#define VAL_GPIOB_PUPDR                 (PIN_PUPDR_FLOATING(PB00_SPI_EEPROM_CS) | \
					 PIN_PUPDR_PULLDOWN(PB01) | \
					 PIN_PUPDR_PULLDOWN(PB02) | \
					 PIN_PUPDR_FLOATING(PB03_UART_TX) | \
					 PIN_PUPDR_FLOATING(PB04_UART_RX) | \
					 PIN_PUPDR_FLOATING(PB05_FDCAN_RX) | \
					 PIN_PUPDR_FLOATING(PB06_FDCAN_TX) | \
					 PIN_PUPDR_PULLUP(PB07_I2C_SDA) | \
...
#define VAL_GPIOB_ODR                   (PIN_ODR_LEVEL_HIGH(PB00_SPI_EEPROM_CS) | \
					 PIN_ODR_LEVEL_HIGH(PB01) | \
					 PIN_ODR_LEVEL_HIGH(PB02) | \
					 PIN_ODR_LEVEL_HIGH(PB03_UART_TX) | \
					 PIN_ODR_LEVEL_HIGH(PB04_UART_RX) | \
					 PIN_ODR_LEVEL_HIGH(PB05_FDCAN_RX) | \
					 PIN_ODR_LEVEL_HIGH(PB06_FDCAN_TX) | \
					 PIN_ODR_LEVEL_HIGH(PB07_I2C_SDA) | \
...
#define VAL_GPIOB_AFRL			(PIN_AFIO_AF(PB00_SPI_EEPROM_CS, 0) | \
					 PIN_AFIO_AF(PB01, 0) | \
					 PIN_AFIO_AF(PB02, 0) | \
					 PIN_AFIO_AF(PB03_UART_TX, 7) | \
					 PIN_AFIO_AF(PB04_UART_RX, 7) | \
					 PIN_AFIO_AF(PB05_FDCAN_RX, 9) | \
					 PIN_AFIO_AF(PB06_FDCAN_TX, 9) | \
					 PIN_AFIO_AF(PB07_I2C_SDA, 4))
...
#define VAL_GPIOF_MODER                 (PIN_MODE_ALTERNATE(PF00_OSC_IN) | \
					 PIN_MODE_OUTPUT(PF01_CAN_TERMR_EN) | \
					 PIN_MODE_INPUT(PF02) | \
					 PIN_MODE_INPUT(PF03) | \
					 PIN_MODE_INPUT(PF04) | \
					 PIN_MODE_INPUT(PF05) | \
...
#define VAL_GPIOF_OTYPER                (PIN_OTYPE_PUSHPULL(PF00_OSC_IN) | \
					 PIN_OTYPE_PUSHPULL(PF01_CAN_TERMR_EN) | \
...
#define VAL_GPIOF_OSPEEDR               (PIN_OSPEED_SPEED_HIGH(PF00_OSC_IN) | \
					 PIN_OSPEED_SPEED_VERYLOW(PF01_CAN_TERMR_EN) | \
...
#define VAL_GPIOF_PUPDR                 (PIN_PUPDR_FLOATING(PF00_OSC_IN) | \
					 PIN_PUPDR_FLOATING(PF01_CAN_TERMR_EN) | \
...
#define VAL_GPIOF_ODR                   (PIN_ODR_LEVEL_HIGH(PF00_OSC_IN) | \
					 PIN_ODR_LEVEL_LOW(PF01_CAN_TERMR_EN) | \
...
#define VAL_GPIOF_AFRL			(PIN_AFIO_AF(PF00_OSC_IN, 0) | \
					 PIN_AFIO_AF(PF01_CAN_TERMR_EN, 0) | \
					 PIN_AFIO_AF(PF02, 0) | \
					 PIN_AFIO_AF(PF03, 0) | \
					 PIN_AFIO_AF(PF04, 0) | \
					 PIN_AFIO_AF(PF05, 0) | \
...
#define AF_PA05_SPI_SCK                  5U
#define AF_LINE_SPI_SCK                  5U
#define AF_PA06_SPI_MISO                 5U
#define AF_LINE_SPI_MISO                 5U
#define AF_PA07_SPI_MOSI                 5U
#define AF_LINE_SPI_MOSI                 5U
#define AF_PA08_SRV1                     6U
#define AF_LINE_SRV1                     6U
#define AF_PA09_SRV2                     6U
#define AF_LINE_SRV2                     6U
#define AF_PA10_SRV3                     6U
#define AF_LINE_SRV3                     6U
#define AF_PA11_SRV4                     11U
#define AF_LINE_SRV4                     11U
#define AF_PA13_SWDIO                    0U
#define AF_LINE_SWDIO                    0U
#define AF_PA14_SWCLK                    0U
#define AF_LINE_SWCLK                    0U
#define AF_PA15_I2C_SCL                  4U
#define AF_LINE_I2C_SCL                  4U
#define AF_PB03_UART_TX                  7U
#define AF_LINE_UART_TX                  7U
#define AF_PB04_UART_RX                  7U
#define AF_LINE_UART_RX                  7U
#define AF_PB05_FDCAN_RX                 9U
#define AF_LINE_FDCAN_RX                 9U
#define AF_PB06_FDCAN_TX                 9U
#define AF_LINE_FDCAN_TX                 9U
#define AF_PB07_I2C_SDA                  4U
...
#define SRV1_TIM	 1
#define SRV1_TIM_FN	 CH
#define SRV1_TIM_CH	 1
#define SRV1_TIM_AF	 6
#define SRV2_TIM	 1
#define SRV2_TIM_FN	 CH
#define SRV2_TIM_CH	 2
#define SRV2_TIM_AF	 6
#define SRV3_TIM	 1
#define SRV3_TIM_FN	 CH
#define SRV3_TIM_CH	 3
#define SRV3_TIM_AF	 6
#define SRV4_TIM	 1
#define SRV4_TIM_FN	 CH
#define SRV4_TIM_CH	 4
#define SRV4_TIM_AF	 11
#define UART_TX_USART	 2
#define UART_TX_USART_FN	 TX
#define UART_TX_USART_AF	 7
#define UART_RX_USART	 2
#define UART_RX_USART_FN	 RX
#define UART_RX_USART_AF	 7
#define RGBLED_TIM	 8
...
#define DYNAMIC_FUNCTION_PIN \
	...
	LINE_UART_TX, \
	LINE_I2C_SDA
#define DYNAMIC_FUNCTION_PIN_SIZE 	 12
